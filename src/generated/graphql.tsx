...
export type LaunchesListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_name' | 'launch_year' | 'launch_success' | 'upcoming'>
  )>>> }
);
...
export type LaunchinfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'launch_success' | 'id' | 'mission_name' | 'details' | 'launch_year'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
 ...
 * });
 */
export function useLaunchesListQuery(baseOptions?: Apollo.QueryHookOptions<LaunchesListQuery, LaunchesListQueryVariables>) {
        return Apollo.useQuery<LaunchesListQuery, LaunchesListQueryVariables>(LaunchesListDocument, baseOptions);
      }
export function useLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesListQuery, LaunchesListQueryVariables>) {
          return Apollo.useLazyQuery<LaunchesListQuery, LaunchesListQueryVariables>(LaunchesListDocument, baseOptions);
        }
export type LaunchesListQueryHookResult = ReturnType<typeof useLaunchesListQuery>;
export type LaunchesListLazyQueryHookResult = ReturnType<typeof useLaunchesListLazyQuery>;
export type LaunchesListQueryResult = Apollo.QueryResult<LaunchesListQuery, LaunchesListQueryVariables>;
